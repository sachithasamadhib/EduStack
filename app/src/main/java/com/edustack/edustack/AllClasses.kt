...
class AllClasses : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val updateBtn = findViewById<Button>(R.id.updateID)
        ...
        val bottomSheetUI = layoutInflater.inflate(R.layout.bottom_sheet_update_class, null)
        //start time
        ...
        val getTimeStart: Button = bottomSheetUI.findViewById(R.id.timeShow)//button 1 (start time)
        ...
        val getTimeEnd: Button = bottomSheetUI.findViewById(R.id.timeShowEnd)//button 2 (end time)
